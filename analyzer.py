...
html = "<html><body><h1>Analyzer.py for apkMethodTracker</h1><h3>Note: Sorted by file modification time (from oldest to newest). The order can be affected by loops, threadings and background tasks.</h3><button id = 'tops' onclick='topSwitch()' style='background: cyan;'>Show all</button><br><br>"
